...
const S = {
  ...
  bgOverlay: {
    ...
    background: `
      radial-gradient(ellipse 70% 50% at 15% 10%, rgba(201,166,97,0.06) 0%, transparent 60%),
      radial-gradient(ellipse 50% 70% at 85% 90%, rgba(157,107,92,0.04) 0%, transparent 60%),
  ...
  stepLine: (done) => ({
    ...
    background: done ? T.accent : "rgba(157,107,92,0.1)",
  ...
  mainCard: {
    maxWidth: 800, margin: "36px auto 60px",
  ...
  dtSectionTitle: {
    ...
    color: "rgba(157,107,92,0.5)", marginBottom: 12, fontWeight: 700,
  },
  ...
  formLabel: { fontSize: 10, letterSpacing: 3, textTransform: "uppercase", color: "rgba(157,107,92,0.55)", fontWeight: 700 },
  formInput: {
    background: "rgba(255,255,255,0.04)", border: `1px solid ${T.border}`,
    borderRadius: 2, padding: "12px 14px", color: T.text,
  ...
  summaryRow: (total) => ({
    ...
    padding: "10px 0", borderBottom: total ? "none" : "1px solid rgba(157,107,92,0.06)",
  }),
  summaryLabel: { fontSize: 10, letterSpacing: 2, textTransform: "uppercase", color: "rgba(157,107,92,0.45)" },
  summaryVal: (total) => ({
  ...
  btnSecondary: {
    ...
    background: "transparent", color: "rgba(157,107,92,0.6)",
    border: `1px solid rgba(157,107,92,0.2)`, padding: "14px 28px",
...
// ─── DATA ─────────────────────────────────────────────────────────────────────
const SERVICES = [
  { icon: "💈", name: "Corte Clásico",      price: 18, dur: "30 min" },
  { icon: "🧔", name: "Corte + Barba",      price: 28, dur: "50 min" },
  { icon: "🪒", name: "Afeitado Navaja",    price: 22, dur: "40 min" },
  { icon: "✂️", name: "Degradado Moderno",  price: 20, dur: "35 min" },
  { icon: "🌿", name: "Tratamiento Capilar",price: 35, dur: "60 min" },
  { icon: "👑", name: "Paquete Caballero",  price: 65, dur: "90 min" },
];
const BARBERS = [
  { emoji: "🧑‍🦱", name: "Carlos Hermano", spec: "Degradados & Fade" },
  { emoji: "👨‍🦲", name: "Miguel Ángel",   spec: "Barbas & Afeitado" },
  { emoji: "👨‍🦳", name: "Diego Ruiz",     spec: "Clásico & Vintage" },
  { emoji: "🎲",   name: "Sin Preferencia",spec: "Cualquier barbero" },
];
              ...
              <div style={S.barberGrid}>
                {BARBERS.map((b) => (
                  <div key={b.name} style={S.barberCard(barber?.name === b.name)}
                    onClick={() => setBarber(b)}>
                    <div style={S.barberAvatar(barber?.name === b.name)}>{b.emoji}</div>
